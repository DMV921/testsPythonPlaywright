...
class ExamplePage(ExampleBasePage):
    ...
    @allure.step("Выполнение примера действия")
    def example_scenario_2(self, INPUT=URL):
        """ Пример теста """
        self.base.logger.info(f"Выполняем пример действия с данными: {URL}")
        # 1. Навигация
        self.base.page.goto(INPUT)
...
# команда для запуска: pytest page/example/example_page.py::test_example_scenario --browser=firefox --headless
# Пример проверки теста для этого Page Object
